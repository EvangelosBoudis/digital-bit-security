package com.nativeboys.password.manager.ui.content.itemOverview
...
class ItemOverviewFragment : ZTransactionFragment(
...
), View.OnClickListener, AdapterClickListener<FieldContentDto>, FragmentDialogListener {
    ...
    override fun onClick(v: View?) {
        ...
        when (view.id) {
            ...
            R.id.edit_btn -> {
                navController.navigate(ItemOverviewFragmentDirections.actionItemOverviewToItemConstructor(viewModel.itemId, null))
            }
            R.id.delete_btn -> {
