package com.nativeboys.password.manager.ui.content.confirmation
...
class ConfirmationFragment : DialogFragment(), View.OnClickListener {
    ...
    var fragmentDialogListener: FragmentDialogListener? = null
    ...
    override fun onDetach() {
        super.onDetach()
        fragmentDialogListener = null
    }

    override fun onClick(v: View?) {
        val view = v ?: return
        fragmentDialogListener?.onClick(this, view) ?: dismiss()
    }
